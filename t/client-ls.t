...
#
# I don't think this is worth implementing. Besides any shell user can do:
# todo.pl list | grep regex
#
...
>>> todo.sh list "O'Brian"
4 get money from O'Brian
--
TODO: 1 of 5 tasks shown

>>> todo.sh list "get   money"
5 just get   money!
--
TODO: 1 of 5 tasks shown
EOF
...
test_todo_session('check that blank lines are ignored for less than 10 items',
		  <<'EOF'
>>> todo.sh list
