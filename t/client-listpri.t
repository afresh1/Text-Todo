...
test_todo_session 'listpri filtering of inverted TERMs', <<'EOF';
>>> todo.sh -p listpri -ccc
3 (A) aaa zzz this line should be first.
5 (B) bbb yyy this line should be second.
--
TODO: 2 of 6 tasks shown

>>> todo.sh -p listpri -ccc -yyy
3 (A) aaa zzz this line should be first.
--
TODO: 1 of 6 tasks shown

>>> todo.sh -p listpri b second -ccc
5 (B) bbb yyy this line should be second.
--
TODO: 1 of 6 tasks shown

>>> todo.sh -p listpri b "should be" -bbb -ccc
--
TODO: 0 of 6 tasks shown

>>> todo.sh -p listpri -zzz
5 (B) bbb yyy this line should be second.
1 (B) ccc xxx this line should be third.
--
TODO: 2 of 6 tasks shown
